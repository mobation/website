<?php
/* Smarty version 3.1.31, created on 2020-01-22 22:27:28
  from "C:\xampp\htdocs\formtools\themes\default\admin\forms\edit\tab_views.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e28be40ee1dc7_56424900',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd4275f80acd2d1ef67de8385319b0eb1f67d7951' => 
    array (
      0 => 'C:\\xampp\\htdocs\\formtools\\themes\\default\\admin\\forms\\edit\\tab_views.tpl',
      1 => 1573338106,
      2 => 'file',
    ),
  ),
...
function content_5e28be40ee1dc7_56424900 (Smarty_Internal_Template $_smarty_tpl) {
...
if (!is_callable('smarty_function_views_dropdown')) require_once 'C:\\xampp\\htdocs\\formtools\\global\\smarty_plugins\\function.views_dropdown.php';
?>
...
"/>
                ...
                <div class="sortable groupable view_list">
                    <ul class="header_row">
                        ...
                        <li class="col5">
                            <div title="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_columns_sp'];?>
"></div>
                        </li>
                        <li class="col6">
                            <div title="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_fields_sp'];?>
"></div>
                        </li>
                        <li class="col7">
                            <div title="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_tabs_sp'];?>
"></div>
                        </li>
                        <li class="col8">
                            <div title="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_filters_sp'];?>
"></div>
                        </li>
                    ...
                    <ul class="rows connected_sortable">
                        <li class="sortable_row empty_group<?php if (count($_smarty_tpl->tpl_vars['views']->value) != 0) {?> hidden<?php }?>">
                            <div class="clear"></div>
                        </li>
...
?>
                                ...
                                <li class="col5"><a href="../../redirect.php?page=edit_view&view_id=<?php echo $_smarty_tpl->tpl_vars['view_id']->value;?>
&edit_view_tab=2"
                                                    title="<?php echo count($_smarty_tpl->tpl_vars['view']->value['columns']);?>
...
"><?php echo count($_smarty_tpl->tpl_vars['view']->value['columns']);?>
                                ...
                                <li class="col6"><a href="../../redirect.php?page=edit_view&view_id=<?php echo $_smarty_tpl->tpl_vars['view_id']->value;?>
&edit_view_tab=3"
                                                    title="<?php echo count($_smarty_tpl->tpl_vars['view']->value['fields']);?>
...
"><?php echo count($_smarty_tpl->tpl_vars['view']->value['fields']);?>
                                ...
                                <li class="col7"><a href="../../redirect.php?page=edit_view&view_id=<?php echo $_smarty_tpl->tpl_vars['view_id']->value;?>
&edit_view_tab=4"
                                                    title="<?php echo count($_smarty_tpl->tpl_vars['view']->value['tabs']);?>
...
"><?php echo count($_smarty_tpl->tpl_vars['view']->value['tabs']);?>
                                ...
                                <li class="col8"><a href="../../redirect.php?page=edit_view&view_id=<?php echo $_smarty_tpl->tpl_vars['view_id']->value;?>
&edit_view_tab=5"
                                                    title="<?php echo count($_smarty_tpl->tpl_vars['view']->value['filters']);?>
...
"><?php echo count($_smarty_tpl->tpl_vars['view']->value['filters']);?>
                                ...
                                <li class="col9 edit"><a href="../../redirect.php?page=edit_view&view_id=<?php echo $_smarty_tpl->tpl_vars['view_id']->value;?>
&edit_view_tab=1"></a></li>
                                <li class="col10 colN del"></li>
                            </ul>
                            <div class="clear"></div>
                        </div>
